...
void MatPlot::display_axes(){
    if(is_debug1){printf("mode: %d handle: %4d Axes  #Children %ld\n",
...
void MatPlot::display_surface(){
    if(is_debug1){printf("mode: %d handle: %4d Surface type %d, Z.size %ld\n",
...
void MatPlot::display_patch(){
    if(is_debug1){printf("display:%4d Patch :type %d, Faces.size %ld\n",
